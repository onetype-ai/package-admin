$ot.ui.navbar = onetype.Addon('ui.navbar', (addon) =>
{
	addon.Field('id', {
		type: 'string',
		required: true,
	...
	addon.Field('isOpen', {
		type: 'boolean',
		value: false,
		description: 'Computed. True when this item is the one whose surface is open. Reads through the $ot.ui.navbar.open setting.'
	},
...
Object.assign($ot.ui.navbar, {
	opened: () => $ot.ui.navbar.ItemGet($ot.modules.settings.get('ui.navbar.open', null)),
