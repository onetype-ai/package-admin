onetype.AddonReady('admin.dashboard.types', function(types)
{
    types.Item({
                    ...
                    series: {
                        ...
                        each: {
                            ...
                            config: {
                                ...
                                color: {
                                    type: 'string',
                                    description: 'Series color name. Empty uses the widget accent.'
                                },
                                points: {
                                    type: 'array',
                                    value: [],
        ...
        render: function()
        {
            return '<e-admin-charts-line :background="0" :labels="payload.labels" :series="payload.series"></e-admin-charts-line>';
        }
    });
});
