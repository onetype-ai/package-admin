$ot.ui.dock = onetype.Addon('ui.dock', (addon) =>
{
	addon.Field('id', {
		type: 'string',
		required: true,
	...
	addon.Field('isOpen', {
		type: 'boolean',
		value: false,
		description: 'Computed. True when this item is the one open on the rail. Reads and writes through the persisted $ot.ui.dock.open setting.'
	},
