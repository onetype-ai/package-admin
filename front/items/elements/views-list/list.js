    ...
    elements.Item({
        ...
        config: {
            items: {
                ...
                value: [{
                    ...
                    image: 'https://picsum.photos/id/1018/96/96',
                    status: {
                        label: 'Published',
                        color: 'green'
                    },
                    ...
                    description: 'What packages, templates and integrations earn on one platform.',
                    image: 'https://picsum.photos/id/1015/96/96',
                    status: {
                        label: 'In review',
                        color: 'blue'
                    },
                    ...
                    description: 'Every action in the platform is a command an AI can drive.',
                    icon: 'terminal',
                    color: 'brand',
                    status: {
                        label: 'Published',
            ...
            background: {
                ...
                value: 1,
                options: [0, 1, 2, 3],
                description: 'Background depth 1-3 of the list surface. Empty renders it bare. 0 is transparent, no background or borders.'
            },
            _open: {
                type: 'function',
        ...
        render: function()
        {
            const statusFor = (item) =>
            {
                ...
                const status = typeof item.status === 'object' ? item.status : { label: String(item.status) };
            ...
            this.classes = () =>
            {
                ...
                return ['box', hasBackground && 'bg-' + this.background, this._open && 'clickable']
                    .filter(Boolean).join(' ');
            };
