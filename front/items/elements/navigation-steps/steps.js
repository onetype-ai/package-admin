    ...
    elements.Item({
            ...
            items: {
                ...
                value: [
                    { id: 'account', label: 'Account',
                        description: 'Name and workspace URL.' },
                    { id: 'team', label: 'Invite the team',
                        description: 'Add people by email.' },
                    { id: 'apps', label: 'Install apps',
                        description: 'Pick your first packages.' },
        ...
        render: function()
        {
            ...
            this.classes = () =>
            {
                ...
                return ['box', this.orientation, hasBackground && 'bg-' + this.background, this.connected && 'connected'].filter(Boolean).join(' ');
            };
