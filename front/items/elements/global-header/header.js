...
{
    elements.Item({
        id: 'admin-global-header',
        addon: 'admin',
        name: 'Header',
        description: 'Detail page header: accent tinted logo tile, eyebrow, title, description, status badge, meta row and an actions slot.',
        collection: 'Home',
        config: {
            icon: {
                type: 'string',
            ...
            background: {
                ...
                value: 0,
                options: [0, 1, 2, 3],
                description: 'Background depth of the header band from 1 to 3, closed with a bottom border. 0 renders transparent, no borders.'
            },
            container: {
                type: 'string',
                options: ['s', 'm', 'l', 'full'],
